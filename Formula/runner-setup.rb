...
class RunnerSetup < Formula
  ...
  # Replace the placeholder below with the real digest AFTER pushing tag v1.0.0:
  #   curl -fsSL https://github.com/joeblau/homebrew-hb/archive/refs/tags/v1.0.0.tar.gz | shasum -a 256
